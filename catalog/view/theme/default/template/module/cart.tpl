<div id="cart">
    <div class="heading">
        <a href="javascript:void(0);"><span id="cart-total"><?php echo $text_items; ?></span><i class="glyphicon glyphicon-shopping-cart"></i></a>
    </div>
    <div class="content">
        ...
        <div class="checkout form__button-holder">
            <a class="button" href="<?php echo $cart; ?>"><?php echo $text_cart; ?></a>
            <a class="button button--green" href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a>
        </div>
        <?php } else { ?>
